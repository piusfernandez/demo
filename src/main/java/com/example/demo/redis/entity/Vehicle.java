...
public class Vehicle {
	...
	public String toString() {
		return "Vehicle [vinPrefix=" + vinPrefix + ", vinModelYearChar=" + vinModelYearChar + ", modelYear=" + modelYear
				+ ", makeCode=" + makeCode + ", makeName=" + makeName + ", modelDesc=" + modelDesc + ", seriesName="
				+ seriesName + ", displacement=" + displacement + ", mcClassName=" + mcClassName + ", engineType="
				+ engineType + ", hp=" + hp + ", torque=" + torque + ", drive=" + drive + ", transmission="
				+ transmission + ", dryWeight=" + dryWeight + ", wheelbase=" + wheelbase + ", retailPrice="
				+ retailPrice + ", absEquipped=" + absEquipped + ", exhaustName=" + exhaustName + "]";
	}
